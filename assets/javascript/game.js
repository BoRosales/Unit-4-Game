...
$("#ritaRep").data("stats", {currentHP: 120, charAP: 12, currentMultiplyer: 1, playerName: "Rita Repulsa"});
$("#alpha").data("stats", {currentHP: 100, charAP: 15, currentMultiplyer: 1, playerName: "Alpha"});
$("#grnRan").data("stats", {currentHP: 150, charAP: 11, currentMultiplyer: 1, playerName: "Green Ranger"});
$("#redRan").data("stats", {currentHP: 180, charAP: 9, currentMultiplyer: 1, playerName: "Red Ranger"});
//console.log($("#ritaRep").data("stats").currentHP);
